...
const JobListing = () => {
  ...
  return (
    <div className='container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8'>
                        ...
                        <div className='mb-4 text-gray-600'>
                            ...
                            {searchFilter.location && (
                                <span className='ml-3 inline-flex items-center gap-2.5 bg-red-50 border border-red-200 px-4 py-1.5 rounded'>
                                    {searchFilter.location}
                                    <img onClick={e => setSearchFilter(prev => ({...prev,location:""}))} className='cursor-pointer' src={assets.location_icon} alt="" />
                                </span>
                            )}
                        </div>
                    </>
        ...
        {/* Job listing  */}
        <section className='w-full lg:w-3/4 text-lg max-lg:px-4'>
            ...
            {filteredJobs.length > 0 && (
                <div className='flex items-center justify-center space-x-2 mt-10'>
                    ...
                    <a href="#job-list">
                        <img onClick={() => setCurrentPage(Math.min(currentPage+1,Math.ceil(filteredJobs.length / 6)))} src={assets.right_arrow_icon} alt="icon" />
                    </a>
                </div>
            )}
        </section>
