...
const RecruiterLogin = () => {
  ...
  const [isTextDataSubmited, setIsTestDataSubmited] = useState(false)

  const OnSubmitHandler = async (e) => {
    e.preventDefault();

    if(state === 'Sign Up' && !isTextDataSubmited ){
      setIsTestDataSubmited(true)
    }
  }
  ...
  return (
    <div className="absolute inset-0 z-20 backdrop-blur-sm bg-black/30 flex justify-center items-center">
